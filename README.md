...
See [![full API](https://pkg.go.dev/badge/github.com/lumavpn/systray.svg)](https://pkg.go.dev/github.com/lumavpn/systray) as well as [CHANGELOG](https://github.com/lumavpn/systray/tree/master/CHANGELOG.md).
...
```sh
git clone https://github.com/lumavpn/systray
cd systray/example
